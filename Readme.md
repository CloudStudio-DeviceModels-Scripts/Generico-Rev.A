...
# Parsing + Configuration Script – Generico - Rev. A

This **Parsing + Configuration** script is designed for the **Generico** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Generico Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Generico** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
